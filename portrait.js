...
(function(){
  ...
  /* GEOMETRIA DEL HOMBRO APROBADA — no tocar sin motivo.
     ...
     celdas de las 58 de la rejilla, de la base del cuello hacia abajo:
       ...
       26, 31, 34, 38, 41, 44, 48, 52, 55, 56, 57, 58, 58

     FLARE 1.0 es exactamente lineal: la linea del hombro va recta del
     cuello a la esquina inferior. Se llego ahi bajando desde 2.2, que
     dejaba el hombro estrecho un buen tramo (26, 28, 30, 32) y le hacia
     pegar el estiron al final — se notaba en dos sitios, el hombro caia
     mas y las esquinas de abajo quedaban mas vacias.

     Si al tocar algo la progresion se aplana a media altura o deja de
     llegar a 58, se ha roto.
     ...
     sacar el hombro por los LADOS forzando el ancho completo desde cierta
     altura (deja media docena de filas planas apoyadas en los bordes) y
     bajar de 0.9, que engorda el arranque del cuello sin abrir mas el
     hombro — de 1.0 a 0.85 solo se gana una celda a media altura y el
     cuello pasa de 26 a 28. */
  ...
  const FLARE = 1.0;      // curva con la que el hombro sale del encuadre
